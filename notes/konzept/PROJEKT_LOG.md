...
**Runde 5 (Nicks Punktliste):** S17 AFA erweitert (was die Truppe macht: „Fahndung bündeln, systematische Kontrollen" — BR24-Beleg), S18 „nicht einfach irgendein Gegner", S19 „Krah hat **angeblich** nichts gewusst" (Aussage, nicht Fakt), **S20 komplett ersetzt**: Weidel „Schwarz-Rot ist vorbei" → Höcke „Alles für Deutschland" (verbotene SA-Parole, 2× LG-Halle verurteilt, BGH rechtskräftig — ZEIT-BGH-Kopie + tagesschau, Zitat belegt als gerufene Losung). **Streichungen:** Agrar-Quiz (S25, „zu irrelevant für normale Wähler") und „Nach der Wahl"-Timeline raus → 35 Szenen, 2 überzählige OG-PNGs gelöscht (Skill-Regel). **Hero in AfD-Blau** (#009EE3, index.astro `accent={i === 0 ? '#009EE3' : chapter?.accent}`) — ab Szene 2 die gewohnte Palette (visuell verifiziert: Hero blau getönt, Szene 2 orange). 35 Szenen live auf /preview/ (gh-pages `22a6d4e`, Anker `85fef21`), gelöschte og/scene-35.png live 404 ✓.
